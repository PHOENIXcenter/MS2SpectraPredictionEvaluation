...
#MQ结果中的谱图title和对应的sequence
mq_title2seq = {}
#MQ和pFind3里肽段信息相同的部分
same_scans = []

#获取MQ结果中的谱图title和对应的sequence，将获取的数据放到mq_title2seq中
...
#获取pFind3结果中的谱图title和对应的sequence，并和mq_title2seq中做对比，选择相同的放入same_scan中
...
#过滤掉长度不符合要求、电荷不符合要求、修饰信息不符合要求的肽段
